...
pub struct Cdb {
    ...
    pub porta_per: u16,
    pub porta_rate: i16,
    pub add_begin_time: u8,
    pub add_begin_reset: u8,
    pub return_ptr: u16,
    pub return_step: u16,
    pub add_begin: i32,
    pub sfx_flag: u8,
    pub sfx_priority: u8,
    pub sfx_lock_time: i16,
    pub sfx_code: u32,
    pub hw_idx: usize,
}
...
#[derive(Debug, Copy, Clone, Inspect)]
pub struct Pdblk {
    /// Position of the first pattern in the current song
    pub first_pos: u16,
    /// Position of the last pattern in the current song
    pub last_pos: u16,
    /// Which pattern we're playing currently
    pub curr_pos: u16,
    /// Has to do with the tempo of the song
    pub prescale: u16,
    pub p: PdbArr,
}
